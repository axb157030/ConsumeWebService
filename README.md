...
### Blog
Soap web service accepts a payload that is turned from Java to XML. Class of payload should have @XML annotations such @XMLRootElement. The marshallers and unmarshallers that turn the java object to XML and vice versa, should be set and configured. The <underline>WSDL</underline> of the SOAP Web Service should be present in application.  The Soap Client should be configured
